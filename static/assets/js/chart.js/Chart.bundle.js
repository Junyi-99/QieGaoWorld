...
/**
 * Contains interaction related views
...
/**
 * Namespace to hold static tick generation views
...
module.exports = function(Chart) {
	...
	function determineAlignment(tooltip, size) {
		...
		var lf, rf; // views to determine left, right alignment
		var olf, orf; // views to determine if left/right alignment causes tooltip to go outside chart
...
/**
 * Easing views adapted from Robert Penner's easing equations.
